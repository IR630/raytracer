...
Сделан летом 2024 года на летней школе **CGSG** (Computer Graphics Support Group) физматлицея №239 — один из самых объёмных и требовательных по математике личных проектов: от вывода формул пересечений и преломления до синхронизации рендер-потоков.
